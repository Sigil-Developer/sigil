...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Sigil " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"sglseed0", "34.232.161.1"},
    {"sglseed1", "52.45.189.6"},
    {"sglseed2", "34.239.72.167"},
    {"sglseed3", "34.231.228.73"},
    {"sglseed4", "34.239.99.171"},
    {"sglseed5", "18.218.0.160"},
    {"sglseed6", "13.59.189.252"},
    {"sglseed7", "52.15.218.190"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("sgl-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Sigil is probably already running."), addrBind.ToString().c_str());
        else
